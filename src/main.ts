...
razCoin.giveInitialBalanceToClients(clientsWallets.map(c => c.publicKey));

// Initial load transactions from file
razCoin.loadTransactionsIntoBlocks(INITIAL_TRANSACTIONS as Transaction[], clientsWallets);
